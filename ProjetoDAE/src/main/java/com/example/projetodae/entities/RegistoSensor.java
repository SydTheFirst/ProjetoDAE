...
@NamedQueries({
        ...
        @NamedQuery(
                ...
                query = "SELECT r FROM RegistoSensor r WHERE r.idSensor = :idSensor ORDER BY r.timeStamp DESC" // JPQL
        ),
        //get most recent registo of a sensor
        @NamedQuery(
                name = "getMostRecentRegistoSensor",
                query = "SELECT r FROM RegistoSensor r WHERE r.idSensor = :idSensor ORDER BY r.timeStamp DESC" // JPQL
        )
})
